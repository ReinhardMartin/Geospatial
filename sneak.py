...
def scrape_idealista(url: str) -> list[dict]:
    try:
        ...
        with Progress() as progress:
            ...
            while current_url:
                if page_number == 5:
                    print("[INFO] Reached page 5. Waiting few seconds...")
                    time.sleep(15)
                if page_number == 8:
                    print("[INFO] Reached page 8. Waiting few seconds...")
                    time.sleep(15)
                if page_number == 12:
                    print("[INFO] Reached page 12. Waiting few seconds...")
                    time.sleep(10)
                        ...
                        for feature in features_list:
                            ...
                            if "piano" in text.lower():
                                if "terra" in text.lower():
                                    ...
                                    floor_match = re.search(r"(\d+)º?\s*piano", text)  # Updated regex
                                    if floor_match:
